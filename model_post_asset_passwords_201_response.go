...
// checks if the PostAssetPasswords201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostAssetPasswords201Response{}
...
type _PostAssetPasswords201Response PostAssetPasswords201Response

// NewPostAssetPasswords201Response instantiates a new PostAssetPasswords201Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostAssetPasswords201Response() *PostAssetPasswords201Response {
	this := PostAssetPasswords201Response{}
	return &this
}

// NewPostAssetPasswords201ResponseWithDefaults instantiates a new PostAssetPasswords201Response object
...
func (o *PostAssetPasswords201Response) UnmarshalJSON(data []byte) (err error) {
	varPostAssetPasswords201Response := _PostAssetPasswords201Response{}

	err = json.Unmarshal(data, &varPostAssetPasswords201Response)

	if err != nil {
		return err
	}

	*o = PostAssetPasswords201Response(varPostAssetPasswords201Response)
...
type NullablePostAssetPasswords201Response struct {
	value *PostAssetPasswords201Response
	isSet bool
}

func (v NullablePostAssetPasswords201Response) Get() *PostAssetPasswords201Response {
	return v.value
}

func (v *NullablePostAssetPasswords201Response) Set(val *PostAssetPasswords201Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePostAssetPasswords201Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePostAssetPasswords201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostAssetPasswords201Response(val *PostAssetPasswords201Response) *NullablePostAssetPasswords201Response {
	return &NullablePostAssetPasswords201Response{value: val, isSet: true}
}
