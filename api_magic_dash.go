...
type ApiUpdateMagicDashPositionsRequest struct {
	ctx        context.Context
	ApiService *MagicDashAPIService
	body       *UpdateMagicDashPositionsRequest
}

func (r ApiUpdateMagicDashPositionsRequest) Body(body UpdateMagicDashPositionsRequest) ApiUpdateMagicDashPositionsRequest {
	r.body = &body
	return r
}

func (r ApiUpdateMagicDashPositionsRequest) Execute() (*UpdateMagicDashPositions200Response, *http.Response, error) {
	return r.ApiService.UpdateMagicDashPositionsExecute(r)
}

/*
UpdateMagicDashPositions Update positions of multiple Magic Dash Items

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiUpdateMagicDashPositionsRequest
*/
func (a *MagicDashAPIService) UpdateMagicDashPositions(ctx context.Context) ApiUpdateMagicDashPositionsRequest {
	return ApiUpdateMagicDashPositionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return UpdateMagicDashPositions200Response
func (a *MagicDashAPIService) UpdateMagicDashPositionsExecute(r ApiUpdateMagicDashPositionsRequest) (*UpdateMagicDashPositions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateMagicDashPositions200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MagicDashAPIService.UpdateMagicDashPositions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/magic_dash/update_positions"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 422 {
			var v UpdateMagicDashPositions422Response
