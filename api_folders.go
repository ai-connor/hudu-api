...
func (r ApiDeleteFoldersIdRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteFoldersIdExecute(r)
}
...
func (a *FoldersAPIService) DeleteFoldersIdExecute(r ApiDeleteFoldersIdRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FoldersAPIService.DeleteFoldersId")
	if err != nil {
...
func (r ApiGetFoldersRequest) Name(name string) ApiGetFoldersRequest {
	r.name = &name
	return r
}
...
func (r ApiGetFoldersRequest) Execute() (*GetFolders200Response, *http.Response, error) {
...
*/
func (a *FoldersAPIService) GetFolders(ctx context.Context) ApiGetFoldersRequest {
	return ApiGetFoldersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *FoldersAPIService) GetFoldersExecute(r ApiGetFoldersRequest) (*GetFolders200Response, *http.Response, error) {
	var (
...
func (r ApiGetFoldersIdRequest) Execute() (*PostFolders201Response, *http.Response, error) {
	return r.ApiService.GetFoldersIdExecute(r)
}
...
*/
func (a *FoldersAPIService) GetFoldersId(ctx context.Context, id int64) ApiGetFoldersIdRequest {
	return ApiGetFoldersIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *FoldersAPIService) GetFoldersIdExecute(r ApiGetFoldersIdRequest) (*PostFolders201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PostFolders201Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FoldersAPIService.GetFoldersId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPostFoldersRequest) Folder(folder PostFoldersRequest) ApiPostFoldersRequest {
	r.folder = &folder
	return r
}

func (r ApiPostFoldersRequest) Execute() (*PostFolders201Response, *http.Response, error) {
	return r.ApiService.PostFoldersExecute(r)
}
...
*/
func (a *FoldersAPIService) PostFolders(ctx context.Context) ApiPostFoldersRequest {
	return ApiPostFoldersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return PostFolders201Response
func (a *FoldersAPIService) PostFoldersExecute(r ApiPostFoldersRequest) (*PostFolders201Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FoldersAPIService.PostFolders")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPutFoldersIdRequest) Execute() (*PostFolders201Response, *http.Response, error) {
	return r.ApiService.PutFoldersIdExecute(r)
}
...
*/
func (a *FoldersAPIService) PutFoldersId(ctx context.Context, id int64) ApiPutFoldersIdRequest {
	return ApiPutFoldersIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return PostFolders201Response
func (a *FoldersAPIService) PutFoldersIdExecute(r ApiPutFoldersIdRequest) (*PostFolders201Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FoldersAPIService.PutFoldersId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
