...
// checks if the GetPasswordFolders200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPasswordFolders200Response{}
...
type _GetPasswordFolders200Response GetPasswordFolders200Response

// NewGetPasswordFolders200Response instantiates a new GetPasswordFolders200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetPasswordFolders200Response() *GetPasswordFolders200Response {
	this := GetPasswordFolders200Response{}
	return &this
}

// NewGetPasswordFolders200ResponseWithDefaults instantiates a new GetPasswordFolders200Response object
...
func (o *GetPasswordFolders200Response) GetPasswordFolders() []PasswordFolder {
	if o == nil || IsNil(o.PasswordFolders) {
		var ret []PasswordFolder
		return ret
	}
	return o.PasswordFolders
}

// GetPasswordFoldersOk returns a tuple with the PasswordFolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetPasswordFolders200Response) GetPasswordFoldersOk() ([]PasswordFolder, bool) {
	if o == nil || IsNil(o.PasswordFolders) {
		return nil, false
	}
	return o.PasswordFolders, true
}
...
func (o GetPasswordFolders200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PasswordFolders) {
		toSerialize["password_folders"] = o.PasswordFolders
	}
...
func (o *GetPasswordFolders200Response) UnmarshalJSON(data []byte) (err error) {
	varGetPasswordFolders200Response := _GetPasswordFolders200Response{}

	err = json.Unmarshal(data, &varGetPasswordFolders200Response)

	if err != nil {
		return err
	}

	*o = GetPasswordFolders200Response(varGetPasswordFolders200Response)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "password_folders")
...
type NullableGetPasswordFolders200Response struct {
	value *GetPasswordFolders200Response
	isSet bool
}

func (v NullableGetPasswordFolders200Response) Get() *GetPasswordFolders200Response {
	return v.value
}

func (v *NullableGetPasswordFolders200Response) Set(val *GetPasswordFolders200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPasswordFolders200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPasswordFolders200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPasswordFolders200Response(val *GetPasswordFolders200Response) *NullableGetPasswordFolders200Response {
	return &NullableGetPasswordFolders200Response{value: val, isSet: true}
}
