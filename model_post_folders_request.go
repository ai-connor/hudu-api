...
// checks if the PostFoldersRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFoldersRequest{}
...
type _PostFoldersRequest PostFoldersRequest

// NewPostFoldersRequest instantiates a new PostFoldersRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostFoldersRequest() *PostFoldersRequest {
	this := PostFoldersRequest{}
	return &this
}

// NewPostFoldersRequestWithDefaults instantiates a new PostFoldersRequest object
...
func (o *PostFoldersRequest) GetFolder() PostFoldersRequestFolder {
	if o == nil || IsNil(o.Folder) {
		var ret PostFoldersRequestFolder
		return ret
	}
	return *o.Folder
}
...
func (o *PostFoldersRequest) SetFolder(v PostFoldersRequestFolder) {
	o.Folder = &v
}
...
func (o *PostFoldersRequest) UnmarshalJSON(data []byte) (err error) {
	varPostFoldersRequest := _PostFoldersRequest{}

	err = json.Unmarshal(data, &varPostFoldersRequest)

	if err != nil {
		return err
	}

	*o = PostFoldersRequest(varPostFoldersRequest)
...
type NullablePostFoldersRequest struct {
	value *PostFoldersRequest
	isSet bool
}

func (v NullablePostFoldersRequest) Get() *PostFoldersRequest {
	return v.value
}

func (v *NullablePostFoldersRequest) Set(val *PostFoldersRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePostFoldersRequest(val *PostFoldersRequest) *NullablePostFoldersRequest {
	return &NullablePostFoldersRequest{value: val, isSet: true}
}
