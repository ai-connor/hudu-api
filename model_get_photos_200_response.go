...
// checks if the GetPhotos200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPhotos200Response{}

// GetPhotos200Response struct for GetPhotos200Response
type GetPhotos200Response struct {
	Photos               []Photo `json:"photos,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GetPhotos200Response GetPhotos200Response

// NewGetPhotos200Response instantiates a new GetPhotos200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetPhotos200Response() *GetPhotos200Response {
	this := GetPhotos200Response{}
	return &this
}

// NewGetPhotos200ResponseWithDefaults instantiates a new GetPhotos200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetPhotos200ResponseWithDefaults() *GetPhotos200Response {
	this := GetPhotos200Response{}
	return &this
}

// GetPhotos returns the Photos field value if set, zero value otherwise.
func (o *GetPhotos200Response) GetPhotos() []Photo {
...
func (o *GetPhotos200Response) GetPhotosOk() ([]Photo, bool) {
	if o == nil || IsNil(o.Photos) {
		return nil, false
	}
...
func (o *GetPhotos200Response) HasPhotos() bool {
	if o != nil && !IsNil(o.Photos) {
		return true
	}
...
func (o *GetPhotos200Response) SetPhotos(v []Photo) {
	o.Photos = v
}

func (o GetPhotos200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPhotos200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetPhotos200Response) UnmarshalJSON(data []byte) (err error) {
	varGetPhotos200Response := _GetPhotos200Response{}

	err = json.Unmarshal(data, &varGetPhotos200Response)

	if err != nil {
		return err
	}

	*o = GetPhotos200Response(varGetPhotos200Response)
...
type NullableGetPhotos200Response struct {
	value *GetPhotos200Response
	isSet bool
}

func (v NullableGetPhotos200Response) Get() *GetPhotos200Response {
	return v.value
}

func (v *NullableGetPhotos200Response) Set(val *GetPhotos200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPhotos200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPhotos200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPhotos200Response(val *GetPhotos200Response) *NullableGetPhotos200Response {
	return &NullableGetPhotos200Response{value: val, isSet: true}
}

func (v NullableGetPhotos200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPhotos200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
