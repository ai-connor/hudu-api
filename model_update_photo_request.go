...
// checks if the UpdatePhotoRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePhotoRequest{}

// UpdatePhotoRequest struct for UpdatePhotoRequest
type UpdatePhotoRequest struct {
	Photo                *UpdatePhotoRequestPhoto `json:"photo,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UpdatePhotoRequest UpdatePhotoRequest

// NewUpdatePhotoRequest instantiates a new UpdatePhotoRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdatePhotoRequest() *UpdatePhotoRequest {
	this := UpdatePhotoRequest{}
	return &this
}

// NewUpdatePhotoRequestWithDefaults instantiates a new UpdatePhotoRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdatePhotoRequestWithDefaults() *UpdatePhotoRequest {
	this := UpdatePhotoRequest{}
	return &this
}

// GetPhoto returns the Photo field value if set, zero value otherwise.
func (o *UpdatePhotoRequest) GetPhoto() UpdatePhotoRequestPhoto {
	if o == nil || IsNil(o.Photo) {
		var ret UpdatePhotoRequestPhoto
		return ret
	}
	return *o.Photo
}
...
func (o *UpdatePhotoRequest) GetPhotoOk() (*UpdatePhotoRequestPhoto, bool) {
	if o == nil || IsNil(o.Photo) {
		return nil, false
	}
	return o.Photo, true
...
func (o *UpdatePhotoRequest) HasPhoto() bool {
	if o != nil && !IsNil(o.Photo) {
		return true
	}
...
// SetPhoto gets a reference to the given UpdatePhotoRequestPhoto and assigns it to the Photo field.
func (o *UpdatePhotoRequest) SetPhoto(v UpdatePhotoRequestPhoto) {
	o.Photo = &v
}

func (o UpdatePhotoRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdatePhotoRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdatePhotoRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdatePhotoRequest := _UpdatePhotoRequest{}

	err = json.Unmarshal(data, &varUpdatePhotoRequest)

	if err != nil {
		return err
	}

	*o = UpdatePhotoRequest(varUpdatePhotoRequest)
...
type NullableUpdatePhotoRequest struct {
	value *UpdatePhotoRequest
	isSet bool
}

func (v NullableUpdatePhotoRequest) Get() *UpdatePhotoRequest {
	return v.value
}

func (v *NullableUpdatePhotoRequest) Set(val *UpdatePhotoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePhotoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePhotoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePhotoRequest(val *UpdatePhotoRequest) *NullableUpdatePhotoRequest {
	return &NullableUpdatePhotoRequest{value: val, isSet: true}
}

func (v NullableUpdatePhotoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePhotoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
