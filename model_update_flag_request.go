...
type UpdateFlagRequest struct {
	Flag                 *UpdateFlagRequestFlag `json:"flag,omitempty"`
...
func NewUpdateFlagRequest() *UpdateFlagRequest {
...
func (o *UpdateFlagRequest) GetFlag() UpdateFlagRequestFlag {
	if o == nil || IsNil(o.Flag) {
		var ret UpdateFlagRequestFlag
		return ret
	}
	return *o.Flag
}
...
func (o *UpdateFlagRequest) GetFlagOk() (*UpdateFlagRequestFlag, bool) {
	if o == nil || IsNil(o.Flag) {
		return nil, false
	}
	return o.Flag, true
...
func (o *UpdateFlagRequest) HasFlag() bool {
	if o != nil && !IsNil(o.Flag) {
		return true
	}
...
// SetFlag gets a reference to the given UpdateFlagRequestFlag and assigns it to the Flag field.
func (o *UpdateFlagRequest) SetFlag(v UpdateFlagRequestFlag) {
	o.Flag = &v
}
...
func (o *UpdateFlagRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUpdateFlagRequest)
