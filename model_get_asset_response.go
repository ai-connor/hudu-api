...
type _GetAssetResponse GetAssetResponse
...
func (o *GetAssetResponse) GetAsset() Asset {
...
func (o *GetAssetResponse) GetAssetOk() (*Asset, bool) {
	if o == nil || IsNil(o.Asset) {
		return nil, false
	}
	return o.Asset, true
...
func (o *GetAssetResponse) HasAsset() bool {
	if o != nil && !IsNil(o.Asset) {
		return true
	}
...
func (o *GetAssetResponse) SetAsset(v Asset) {
	o.Asset = &v
}
...
func (o *GetAssetResponse) UnmarshalJSON(data []byte) (err error) {
	varGetAssetResponse := _GetAssetResponse{}

	err = json.Unmarshal(data, &varGetAssetResponse)

	if err != nil {
		return err
	}

	*o = GetAssetResponse(varGetAssetResponse)
