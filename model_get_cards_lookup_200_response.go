...
// checks if the GetCardsLookup200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCardsLookup200Response{}
...
type _GetCardsLookup200Response GetCardsLookup200Response

// NewGetCardsLookup200Response instantiates a new GetCardsLookup200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetCardsLookup200Response() *GetCardsLookup200Response {
	this := GetCardsLookup200Response{}
	return &this
}

// NewGetCardsLookup200ResponseWithDefaults instantiates a new GetCardsLookup200Response object
...
func (o *GetCardsLookup200Response) GetIntegratorCards() []IntegratorCard {
	if o == nil || IsNil(o.IntegratorCards) {
		var ret []IntegratorCard
		return ret
	}
	return o.IntegratorCards
}

// GetIntegratorCardsOk returns a tuple with the IntegratorCards field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetCardsLookup200Response) GetIntegratorCardsOk() ([]IntegratorCard, bool) {
	if o == nil || IsNil(o.IntegratorCards) {
		return nil, false
	}
	return o.IntegratorCards, true
}
...
func (o GetCardsLookup200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IntegratorCards) {
		toSerialize["integrator_cards"] = o.IntegratorCards
	}
...
func (o *GetCardsLookup200Response) UnmarshalJSON(data []byte) (err error) {
	varGetCardsLookup200Response := _GetCardsLookup200Response{}

	err = json.Unmarshal(data, &varGetCardsLookup200Response)

	if err != nil {
		return err
	}

	*o = GetCardsLookup200Response(varGetCardsLookup200Response)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "integrator_cards")
...
type NullableGetCardsLookup200Response struct {
	value *GetCardsLookup200Response
	isSet bool
}

func (v NullableGetCardsLookup200Response) Get() *GetCardsLookup200Response {
	return v.value
}

func (v *NullableGetCardsLookup200Response) Set(val *GetCardsLookup200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCardsLookup200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCardsLookup200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCardsLookup200Response(val *GetCardsLookup200Response) *NullableGetCardsLookup200Response {
	return &NullableGetCardsLookup200Response{value: val, isSet: true}
}
