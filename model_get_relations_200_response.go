...
// checks if the GetRelations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRelations200Response{}
...
type _GetRelations200Response GetRelations200Response

// NewGetRelations200Response instantiates a new GetRelations200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetRelations200Response() *GetRelations200Response {
	this := GetRelations200Response{}
	return &this
}

// NewGetRelations200ResponseWithDefaults instantiates a new GetRelations200Response object
...
func (o *GetRelations200Response) UnmarshalJSON(data []byte) (err error) {
	varGetRelations200Response := _GetRelations200Response{}

	err = json.Unmarshal(data, &varGetRelations200Response)

	if err != nil {
		return err
	}

	*o = GetRelations200Response(varGetRelations200Response)
...
type NullableGetRelations200Response struct {
	value *GetRelations200Response
	isSet bool
}

func (v NullableGetRelations200Response) Get() *GetRelations200Response {
	return v.value
}

func (v *NullableGetRelations200Response) Set(val *GetRelations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRelations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRelations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRelations200Response(val *GetRelations200Response) *NullableGetRelations200Response {
	return &NullableGetRelations200Response{value: val, isSet: true}
}
