...
func (o *CreateListRequest) GetList() CreateListRequestList {
	if o == nil || IsNil(o.List) {
		var ret CreateListRequestList
		return ret
	}
	return *o.List
}
...
func (o *CreateListRequest) SetList(v CreateListRequestList) {
	o.List = &v
}
...
func (o *CreateListRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCreateListRequest)
